...
std::string Resource::header_single_declaration() {
    static char const literal[] =  {
        32, 32, 32, 32, 115, 116, 97, 116, 105, 99, 32, 115, 116, 100, 58, 58, 115, 116, 114, 105, 110, 103, 32, 123, 123, 114, 101, 115, 111, 117, 114, 99, 101, 95, 110, 97, 109, 101, 125, 125, 40, 41, 59, 
    };
    return std::string(literal, sizeof(literal)/sizeof(char));
}
...
std::string Resource::header_single_resource_name() {
    static char const literal[] =  {
        32, 32, 32, 32, 32, 32, 32, 32, 34, 123, 123, 114, 101, 115, 111, 117, 114, 99, 101, 95, 110, 97, 109, 101, 125, 125, 34, 44, 
    };
    return std::string(literal, sizeof(literal)/sizeof(char));
}
