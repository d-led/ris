...
std::string Resource::header_on_no_key() {
    static char const literal[] =  {
        112, 117, 98, 108, 105, 99, 58, 10, 32, 32, 32, 32, 115, 116, 97, 116, 105, 99, 32, 115, 116, 100, 58, 58, 115, 116, 114, 105, 110, 103, 32, 79, 110, 78, 111, 75, 101, 121, 40, 41, 32, 123, 10, 32, 32, 32, 32, 32, 32, 32, 32, 47, 47, 32, 99, 111, 117, 108, 100, 32, 98, 101, 32, 99, 111, 110, 102, 105, 103, 117, 114, 101, 100, 32, 116, 111, 32, 116, 104, 114, 111, 119, 10, 32, 32, 32, 32, 32, 32, 32, 32, 114, 101, 116, 117, 114, 110, 32, 34, 34, 59, 
        10, 32, 32, 32, 32, 125, 10, 
    };
    return {literal, sizeof(literal)/sizeof(char)};
}
